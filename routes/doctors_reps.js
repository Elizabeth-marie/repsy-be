...
//   const {id, reps_id, doctors_id, sort} = req.body
//
//   knex('doctors_reps').insert({id, emergency_id, steps_id, sort}).returning('*').then(([data]) => res.status(201).json(data)).catch(err => next(err))
// })
//
