  ...
  return knex('meds').del()
    .then(function () {
      ...
      return knex('meds').insert([
        ...
        {id: 6, generic_name: 'Ado-trastuzumab emtansine', brand_name: 'Kadcyla', pharma_company:'Genentech', info:'Kadcyla is a drug for breast cancer', photo:''},
        {id: 7, generic_name: 'Nivolumab', brand_name: 'Opdivo', pharma_company:'Bristol-Myers Squibb', info:'Opdivo is a drug for lung cancer', photo:''},
        {id: 8, generic_name: 'Enzalutamide', brand_name: 'Xtandi', pharma_company:'Astellas Pharma Us, Inc, and Medivation, Inc', info:'Opdivo is a drug for prostate cancer', photo:''},
      ]);
    })
    .then(function () {
